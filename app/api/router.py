...
from app.domains.penilaian_makalah.api import router as penilaian_makalah_router
...
api_router.include_router(
    penilaian_makalah_router, prefix="/penilaian-makalah", tags=["penilaian-makalah"]
)
api_router.include_router(
